...
- `https://app.makerchip.com/` (`app.makerchip.com` must be whitelisted in Claude settings)
...
**Example**:
```bash
curl -c cookies.txt https://app.makerchip\.com/auth/pub/
```
...
curl -b cookies.txt -X POST \
  ...
  https://app.makerchip\.com/project/public/
```
...
**Example**:
```bash
curl -b cookies.txt https://app.makerchip\.com/project/public/066hGD/contents
```
...
**Example**:
```bash
curl -b cookies.txt https://app.makerchip\.com/project/public/066hGD/delete
```
...
```
https://app.makerchip\.com/sandbox/public/{project_id}
```
...
curl -b cookies.txt -H "Accept: text/event-stream" \
  https://app.makerchip\.com/project/public/066hGD/desktopEvents
```
...
# 1. Authenticate
session.get("https://app.makerchip\.com/auth/pub/")
...
# 3. Get browser URL
url = f"https://app.makerchip\.com/sandbox/public/{proj_id}"
print(f"Open: {url}")

# 4. Cleanup
session.get(f"https://app.makerchip\.com/project/public/{proj_id}/delete")
```
...
```bash
#!/bin/bash
SERVER="https://app.makerchip\.com"
...
# Open in browser
echo "https://app.makerchip\.com/sandbox/public/${PROJ_ID}"
...
- [Makerchip IDE](https://app.makerchip\.com/)
